export const lang = {
  ...
  en: {
    ...
    LAYOUT: {
      NOTICE_TEXT: 'Cảm ơn bạn đã đọc hết bài viết!',
      PAY_BUTTON: 'Coffee',
      NOTICE_BUTTON: 'Liên hệ',
    ...
    CONTACT: {
      TITLE: 'Liên hệ',
      DESCRIPTION: 'Nếu bạn có câu hỏi hay góp ý, hãy liên hệ với mình bằng form bên dưới.',
      TG_DESCRIPTION: 'Hoặc liên hệ qua Facebook ',
      SUCCESS_MESSAGE: 'Đã gửi thành công, mình sẽ liên hệ bạn sớm nhất có thể!',
      FORM_USERNAME: 'Bạn tên là gì?',
      FORM_EMAIL: 'Cho mình biết email nhé',
      FORM_CONTENT: 'Nội dung bạn muốn gửi cho mình là gì?',
      SEND_BUTTON: 'Gửi',
      FORM_EMAIL_REQUIRED: '',
      FAILED_MESSAGE: 'Xin lỗi, gửi thất bại, hãy liên hệ mình qua Facebook nhé!'
    },
    FOOTER: {
      COPYRIGHT_START: '',
      COPYRIGHT_NAME: '',
